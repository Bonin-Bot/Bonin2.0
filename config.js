const ownerNumber = ["5511941547847@s.whatsapp.net"] 
// mude somente o numero e não tire o @s.whatsapp.net

const OriginalOwner = '5511941547847' 
// mude para seu numero

const menuimg = 'https://i.imgur.com/A2LabqH.jpeg'
// Link da foto do menu

const registeruser = false
// Se é obrigatório o usuário se registrar para usar os comandos

const callbotmsgs = ['bot', 'BONIN']
...
const backgroundmenuimg = `https://images.wallpapersden.com/image/download/tokyo-revengers-4k-characters_bWVpa2WUmZqaraWkpJRmZ21lrWxnZQ.jpg`
//Link direto da imagem de fundo TAMANHO RECOMENDADO: 1280x720
//Obs: não coloque o texto longo para a imagem não sumir

const backgroundwelcomeimg = `https://images.wallpapersden.com/image/download/tokyo-revengers-4k-characters_bWVpa2WUmZqaraWkpJRmZ21lrWxnZQ.jpg`
...
+ 'FN:Bonin\n' 
+ 'ORG:Ryuzki;\n' 
+ 'TEL;type=CELL;type=VOICE;waid=5540028922:+55 40028922\n' 
+ 'END:VCARD'
